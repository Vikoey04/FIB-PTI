...
from .config import GLOBAL_TMP_PATH, GLOBAL_DATASETS, INITIAL_MODEL_PATH, USE_TRAINED_MODEL, PRETRAINED_MODEL_PATH
...
class ChestXRayModelTrainer:
    ...
    def train_model(self):
        ...
        elif USE_TRAINED_MODEL == True:
            print('Using pre-trained model')
            cwd = os.getcwd()
            model = keras.models.load_model(cwd+PRETRAINED_MODEL_PATH)
        else:
        ...
        print(self.client_config.epochs)
        ...
        cwd = os.getcwd()
        model.save(cwd+INITIAL_MODEL_PATH)
    ...
    def __load_datasets(self):
        ...
        global_dataset_train_path = cwd + GLOBAL_DATASETS + '/chest_xray/train'
        global_dataset_valid_path = cwd + GLOBAL_DATASETS + '/chest_xray/test'
